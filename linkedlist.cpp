...
void
insert_at_beggining (node ** root, int data)
{
...
void
insert_at_middle (node * root, int data, int pos)
{
  node *insert_node = new_node (data);
...
void
insert_at_end (node * root, int data)
{
  node *insert_node = new_node (data);
  node *curr = root;
...
void
delete_at_middle (node * root, int pos)
{
  node *curr = root;
  node *next;
  node *prev;
